...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      vim.list_extend(ensure_installed, {
        ...
        'prettierd', -- Used to format JS/TS/JSON/HTML/CSS/Markdown
      })
  ...
  { -- You can easily change to a different colorscheme.
    ...
    config = function()
      ...
      -- NOTE: Using kanagawa instead (see lua/custom/plugins/kanagawa.lua)
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- Comment lines with gc (gcc for line, gc + motion for selection)
      require('mini.comment').setup()

      -- Auto-close brackets, quotes, etc.
      require('mini.pairs').setup()

      -- NOTE: mini.statusline disabled - using lualine instead
